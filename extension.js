...
function activate(context) {
  ...
  <ul class="list-unstyled">
    ...
    <li>Milk</li>
			...
			const selectedValue1 = await vscode.window.showQuickPick(['Basic Navbar', 'Vertical Navbar', 'Centered Navbar', 'Colored Navbar', 'Brand / Logo', 'Navbar Text', 'Navbar With Dropdown', 'Navbar Forms and Buttons', 'Fixed Navigation Bar'], {
				canPickMany: false,
				placeHolder: 'Select a value'
			});
			if (selectedValue1 === 'Basic Navbar') {
				const editor = vscode.window.activeTextEditor;
				if (!editor) {
					vscode.window.showErrorMessage('No active editor!');
					return;
